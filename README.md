...
- **v0.2.0** (2026-09-09): Bring Clock inside Angular Frame - Integrated Clock.qml within AngularFrame.qml structure, added full clock widget with hands, ticks, numbers, and all features
- **v0.1.0** (2026-09-09): Fix Clck Placement - Minor placement adjustments to AngularFrame.qml and settings.json
- **Initial setup** (2026-09-09): Project scaffold with shell.qml, AngularFrame.qml, and settings.json

---

*Built with QtQuick and Quickshell for a modern Wayland desktop experience.*